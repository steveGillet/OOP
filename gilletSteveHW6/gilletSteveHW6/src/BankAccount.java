...
public class BankAccount
{
   ...
   */
   ...
   public void deposit(String str) throws negativeDeposit
   {
      if (Double.parseDouble(str) < 0)
         throw new negativeDeposit(Double.parseDouble(str));
      balance += Double.parseDouble(str);
   }
   ...
   */
   ...
   public void withdraw(double amount) throws negativeWithdrawal, negativeBalance
   {
      if (amount < 0)
         throw new negativeWithdrawal(amount);
      if ((balance - amount) < 0)
         throw new negativeBalance(amount);
      balance -= amount;
   }
   ...
   */
   ...
   public void withdraw(String str) throws negativeWithdrawal, negativeBalance
   {
      if (Double.parseDouble(str) < 0)
         throw new negativeWithdrawal(Double.parseDouble(str));
      if ((balance - Double.parseDouble(str)) < 0)
         throw new negativeBalance(Double.parseDouble(str));
      balance -= Double.parseDouble(str);
   }
